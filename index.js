...
app.use(cors({
  origin: ['http://localhost:5173', 'https://agentsync-5ab53.web.app', 'https://biograms.web.app',  'https://buildyourbio.vizhva.com' , 'https://resume-builder-ckzi.onrender.com', 'https://resume-builder-28fae.web.app'],
